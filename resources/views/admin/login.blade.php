...
<html lang="en">
  ...
  <body id="body"
  style= "background-image: url(https://images.pexels.com/photos/3771097/pexels-photo-3771097.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);"
  >
        ...
        <div id="login-card" class="card">
            ...
            <div class="card-body">
                ...
                <div  
                    class="title"> Welcome, Admin! 
                </div>

                <div  
                    class="sub-title"> Please enter your username and password to continue. 
                </div>
